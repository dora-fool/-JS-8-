...
Переменная strLet, может быть изменена
Переменная strConst, не может быть изменена, выйдет ошибка
Переменная arrLet, может быть изменена и переопределена. Получается добавляем элемент и затем переопределяем его
Переменная arrConst, не может быть переопределена. Но элементы массива можно изменить (добавить или удалить), потому что const не защищает содержимое массива
